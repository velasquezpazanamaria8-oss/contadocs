...
<aside class="sidebar">
  ...
  <div class="sidebar-footer">
    ...
    <div class="sidebar-user">
      <div style="display:flex;align-items:center;gap:10px;padding:10px 12px;background:var(--gris-50);border-radius:10px;border:1px solid var(--gris-200)">
        ...
        <div style="min-width:0">
          ...
          <?php $planes=getPlanes(); $plan_data=null; foreach($planes as $p) if($p['id']===$user_plan||$p['nombre']===$user_plan){$plan_data=$p;break;} ?>
    ...
    <?php endif; ?>
    <a href="/logout.php" class="nav-item" style="color:var(--gris-400);margin-top:4px">
